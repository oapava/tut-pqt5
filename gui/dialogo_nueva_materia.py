from PyQt5.QtWidgets import QDialog, QVBoxLayout, QDialogButtonBox, QGroupBox, QGridLayout, QLabel, QLineEdit, QComboBox, QMessageBox
...
class Dialogo_nueva_materia(QDialog):
    ...
    def dar_valores(self):
        return {
            ...
            "Semestre": self.txt_semestre.currentText(), 
            "Profesor":self.txt_profesor.text(), 
            "Nota":float(self.txt_nota.text())
        }
